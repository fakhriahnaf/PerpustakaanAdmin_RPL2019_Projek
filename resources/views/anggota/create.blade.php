                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Anggota baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            <label for="prodi" class="col-md-4 control-label">Lokasi</label>
                            <div class="col-md-6">
                            <select class="form-control" name="prodi" required="">
                                <option value=""></option>
                                <option value="TI">Bogor</option>
                                <option value="SI">Depok</option>
                                <option value="KM">Jakarta Selatan</option>
                                <option value="KM">Jakarta Utara</option>
                                <option value="JB">Jakarta Barat</option>
                                <option value="JP">Jakarta Pusat</option>
                                <option value="KM">Tanggerang</option>
                            </select>
                            </div>
                        </div>
